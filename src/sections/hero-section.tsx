...
export default function HeroSection() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      {/* btn */}
      <Button className="bg-secondary-foreground rounded-3xl w-[236px] h-[44px] text-background focus-visible:ring-0 hover:border-none hover:bg-teal-500 focus:outline-none mt-2">
      ...
      <div className="flex-col mt-8">
        ...
        {/* rating */}
        <div className="flex flex-row gap-4 mt-4 items-center ratings-container">
          <img src="trusted-by-1230.svg" alt="" className="trusted-icon" />
          <div className="border border-zinc-300 h-6 ratings-divider"></div>
